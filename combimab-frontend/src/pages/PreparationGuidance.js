...
const stepsData = [
  ...
  { image: image8, description: 'The length of infusion time will vary based on the dose as determined by the patient\'s weight but the rate of infusion should not exceed the maximum for each dose' },
